...
export default function App() {
  ...
  function AdminScreen({ navigation }) {
    ...
    let newreg = {
      latitude: state.vehiclemarker.coordinates.latitude,
      longitude: state.vehiclemarker.coordinates.longitude,
      latitudeDelta: 0.1,
      longitudeDelta: 0.1
    };
    ...
    return (
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
        ...
        <MapView style={{
          ...
          {state.vehiclemarker ?
            (<MapView.Marker
              coordinate={state.vehiclemarker.coordinates}
              title={state.vehiclemarker.title}
